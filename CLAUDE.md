...
原始论文见 notes/paper.md；原始数据的样本见 data/info.md
你可以在 data/processed 下找到一些中间结果的统计数据，如 data/processed/rqvae/preprocess_stats.json 和 data/processed/rqvae/goodreads.sid_health.md
